...
@Disabled // since we replace with `latest.release`, this is going to fail on each new release
class ModernizePluginTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        ...
        // TODO how to load up htmlunit-3.yml to satisfy dependencies?
    ...
    void shouldDoTheWorks() {
        rewriteRun(pomXml("""
          ...
          """.stripIndent()), srcMainJava(spec -> spec.path("something/Example.java"), Assertions.java("""
          package something;
